...
export default function Footer({ onNavigate, currentPage, onOpenLegal, onOpenAdmin }: FooterProps) {
  const instagramId = 'genowl_tech';
  const gmailAccount = 'genowlai@gmail.com';
  ...
  return (
    <footer id="main-footer" className="border-t border-white/[0.08] bg-[#050805] text-zinc-400 pt-12 pb-24 md:pb-12 px-4 sm:px-6 md:px-8 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        {/* Right Contacts (Instagram & Gmail) */}
        <div className="flex flex-col sm:flex-row items-center gap-4 text-xs">
          ...
          <a
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 hover:border-[#f7cc46]/40 text-zinc-300 hover:text-white transition-all group"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 hover:border-[#c6f554]/40 text-zinc-300 hover:text-white transition-all group"
          >
