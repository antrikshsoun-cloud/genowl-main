...
import IsometricSocialDock from './IsometricSocialDock.tsx';
import {
...
export default function Footer({
  ...
  return (
    ...
    >
      {/* Structural placeholder that establishes scroll depth on desktop */}
      <div className="hidden md:block relative w-full md:h-[680px] lg:h-[640px]" />

      {/* Under-Page Canvas: Glued to viewport bottom on desktop, natural fluid flow on mobile */}
      <div className="relative md:fixed md:bottom-0 md:left-0 w-full min-h-[700px] md:h-[680px] lg:h-[640px] z-0 flex flex-col justify-between bg-[#030603] text-zinc-400 border-t border-white/[0.08] shadow-[0_-25px_60px_rgba(0,0,0,0.85)]">
        ...
        >
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <span className="font-bold text-[11px] text-[#c6f554]">𝕏</span>
          ...
          {/* ROW 2.5: Horizontal 3D Isometric Social Grid (Zero Overlap Guaranteed) */}
          <IsometricSocialDock onOpenBrowserCall={onOpenBrowserCall} />
